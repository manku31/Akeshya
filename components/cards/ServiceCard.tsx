...
export default function ServiceCard({
  ...
  return (
    <div className="group service-card bg-white hover:bg-blue-900 rounded-xl shadow-lg border border-gray-200 px-5 py-10 lg:max-w-[350px] space-y-5 h-[400px] lg:h-auto transition-transform duration-300 transform">
